...
CREATE INDEX IF NOT EXISTS idx_tasks_linear_issue ON tasks(issue_identifier);
CREATE INDEX IF NOT EXISTS idx_tasks_linear_stage ON tasks(issue_identifier, pipeline_stage, status);
